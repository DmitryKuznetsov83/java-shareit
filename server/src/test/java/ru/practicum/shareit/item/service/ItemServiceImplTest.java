...
class ItemServiceImplTest {
	...
	void getItems_whenOwnItemsFoundAndNoPagination_thenListReturned() {
		// when
		when(itemRepository.findAllByOwnerIdOrderById(anyInt())).thenReturn(Collections.singletonList(item));
	...
	void getItems_whenOwnItemsFoundAndPagination_thenListReturned() {
		// when
		when(itemRepository.findAllByOwnerIdOrderById(anyInt(), any())).thenReturn(new PageImpl<>(Collections.singletonList(item)));
