...
class ItemControllerTest {
	...
	@Test
	@SneakyThrows
	void patchItem_whenUserIsOwner_thenReturnPatchedItem() {
		// given
	...
	@Test
	@SneakyThrows
	void patchItem_whenUserIsNotOwner_thenThrowUnauthorizedChangeException() {
		// given
		Map<String, String> patch = new HashMap<>();
		patch.put("name", "updated Item A");
		// when
	...
	@Test
	@SneakyThrows
	void searchItems_textNotBlank_thenListReturned() {
		// given
		ItemRequestDto itemRequestDto = ItemRequestDto.builder()
	...
	@Test
	@SneakyThrows
	void searchItems_textBlank_thenEmptyListReturned() {
		// when
	...
	@Test
	@SneakyThrows
	void postComment_whenUserHasFinishedBookings() {
		// given
	...
	@Test
	@SneakyThrows
	void postComment_whenUserNotHasFinishedBookings() {
		// given
		CommentRequestDto commentRequestDto = CommentRequestDto.builder()
				.text("new comment")
				.build();
